...
class TcptraceParser(object):
    ...
    def _createPlotOfLoadingTimes(self, connection_statistics, filename):
        """Creates a pdf loc that shows a plot with the relative time when a page load began on the x-axis
